...
// Menu: Main
// upper: none
MENU_OBJ(scMenuMain, "Simple POS", 7, NULL)
...
MENU_OBJ(scMenuSelectConn, "Scale 0", MAX_NUM_BLE_CONNS, &scMenuMain)
...
MENU_OBJ(scMenuPerConn, NULL, 7, &scMenuSelectConn)
  MENU_ITEM_ACTION("Read Scale",          SimpleCentral_doGattRead)

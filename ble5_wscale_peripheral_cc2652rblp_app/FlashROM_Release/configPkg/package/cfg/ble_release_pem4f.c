 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/ti/ccsv8workspace/CC2652RBv310_Launchpad/ble5_wscale_peripheral_cc2652rblp_app/FlashROM_Release/configPkg/package/cfg/ble_release_pem4f");
